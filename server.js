// NBA Widget Proxy Server v3
// Player search: embedded static roster — VERIFIED IDs ONLY from nba.com player URLs
// Live stats: NBA.com CDN
...
const cache = new Map();
const TTL = { scoreboard: 15000, boxscore: 15000 };
...
// ── VERIFIED ROSTER — all IDs confirmed from nba.com/player/{ID} URLs ──
const NBA_PLAYERS = [
  // Atlanta Hawks
  ...
  {id:1628434,firstName:"Sam",lastName:"Hauser",tricode:"BOS",teamName:"Boston Celtics",position:"F",jersey:"30"},
  // Brooklyn Nets
  ...
  {id:1630172,firstName:"Patrick",lastName:"Williams",tricode:"CHI",teamName:"Chicago Bulls",position:"F",jersey:"44"},
  ...
  {id:1629073,firstName:"Max",lastName:"Strus",tricode:"CLE",teamName:"Cleveland Cavaliers",position:"G-F",jersey:"1"},
  // Dallas Mavericks
  ...
  {id:1629609,firstName:"Dereck",lastName:"Lively II",tricode:"DAL",teamName:"Dallas Mavericks",position:"C",jersey:"2"},
  // Denver Nuggets
  ...
  {id:1629611,firstName:"Julian",lastName:"Strawther",tricode:"DEN",teamName:"Denver Nuggets",position:"G-F",jersey:"3"},
  // Detroit Pistons
  {id:1630595,firstName:"Cade",lastName:"Cunningham",tricode:"DET",teamName:"Detroit Pistons",position:"G",jersey:"2"},
  {id:1631093,firstName:"Ausar",lastName:"Thompson",tricode:"DET",teamName:"Detroit Pistons",position:"F",jersey:"5"},
  {id:1630530,firstName:"Jaden",lastName:"Ivey",tricode:"DET",teamName:"Detroit Pistons",position:"G",jersey:"23"},
  {id:1629054,firstName:"Isaiah",lastName:"Stewart",tricode:"DET",teamName:"Detroit Pistons",position:"C",jersey:"28"},
  {id:1641728,firstName:"Ron",lastName:"Holland II",tricode:"DET",teamName:"Detroit Pistons",position:"F",jersey:"5"},
  {id:1629011,firstName:"Tobias",lastName:"Harris",tricode:"DET",teamName:"Detroit Pistons",position:"F",jersey:"12"},
  ...
  {id:1626172,firstName:"Kevon",lastName:"Looney",tricode:"GSW",teamName:"Golden State Warriors",position:"C",jersey:"5"},
  {id:203921,firstName:"Gary",lastName:"Payton II",tricode:"GSW",teamName:"Golden State Warriors",position:"G",jersey:"0"},
  // Houston Rockets
  {id:1630578,firstName:"Alperen",lastName:"Sengun",tricode:"HOU",teamName:"Houston Rockets",position:"C",jersey:"28"},
  ...
  {id:1642263,firstName:"Reed",lastName:"Sheppard",tricode:"HOU",teamName:"Houston Rockets",position:"G",jersey:"15"},
  {id:1629744,firstName:"Tari",lastName:"Eason",tricode:"HOU",teamName:"Houston Rockets",position:"F",jersey:"17"},
  {id:1629609,firstName:"Cam",lastName:"Whitmore",tricode:"HOU",teamName:"Houston Rockets",position:"F",jersey:"4"},
  {id:1630560,firstName:"Jabari",lastName:"Smith Jr.",tricode:"HOU",teamName:"Houston Rockets",position:"F",jersey:"10"},
  // Indiana Pacers
  {id:1630169,firstName:"Tyrese",lastName:"Haliburton",tricode:"IND",teamName:"Indiana Pacers",position:"G",jersey:"0"},
  ...
  {id:1630178,firstName:"Aaron",lastName:"Nesmith",tricode:"IND",teamName:"Indiana Pacers",position:"F",jersey:"23"},
  {id:1629168,firstName:"Obi",lastName:"Toppin",tricode:"IND",teamName:"Indiana Pacers",position:"F",jersey:"1"},
  // LA Clippers
  ...
  {id:1629773,firstName:"Bones",lastName:"Hyland",tricode:"LAC",teamName:"LA Clippers",position:"G",jersey:"5"},
  // Los Angeles Lakers
  ...
  {id:1629022,firstName:"Dalton",lastName:"Knecht",tricode:"LAL",teamName:"Los Angeles Lakers",position:"G-F",jersey:"4"},
  // Memphis Grizzlies
  {id:1629630,firstName:"Ja",lastName:"Morant",tricode:"MEM",teamName:"Memphis Grizzlies",position:"G",jersey:"12"},
  {id:1628991,firstName:"Jaren",lastName:"Jackson Jr.",tricode:"MEM",teamName:"Memphis Grizzlies",position:"F-C",jersey:"13"},
  {id:1630217,firstName:"Desmond",lastName:"Bane",tricode:"MEM",teamName:"Memphis Grizzlies",position:"G-F",jersey:"22"},
  ...
  {id:1629611,firstName:"GG",lastName:"Jackson II",tricode:"MEM",teamName:"Memphis Grizzlies",position:"F",jersey:"45"},
  // Miami Heat
  ...
  {id:1629639,firstName:"Tyler",lastName:"Herro",tricode:"MIA",teamName:"Miami Heat",position:"G",jersey:"14"},
  ...
  {id:1626169,firstName:"Duncan",lastName:"Robinson",tricode:"MIA",teamName:"Miami Heat",position:"G-F",jersey:"55"},
  {id:1629611,firstName:"Nikola",lastName:"Jovic",tricode:"MIA",teamName:"Miami Heat",position:"F",jersey:"5"},
  // Milwaukee Bucks
  ...
  {id:1630183,firstName:"Jaden",lastName:"McDaniels",tricode:"MIN",teamName:"Minnesota Timberwolves",position:"F",jersey:"3"},
  {id:1629718,firstName:"Naz",lastName:"Reid",tricode:"MIN",teamName:"Minnesota Timberwolves",position:"C",jersey:"11"},
  {id:1630560,firstName:"Nickeil",lastName:"Alexander-Walker",tricode:"MIN",teamName:"Minnesota Timberwolves",position:"G",jersey:"9"},
  {id:1641750,firstName:"Rob",lastName:"Dillingham",tricode:"MIN",teamName:"Minnesota Timberwolves",position:"G",jersey:"11"},
  ...
  {id:1630580,firstName:"Jose",lastName:"Alvarado",tricode:"NOP",teamName:"New Orleans Pelicans",position:"G",jersey:"15"},
  {id:1641736,firstName:"Yves",lastName:"Missi",tricode:"NOP",teamName:"New Orleans Pelicans",position:"C",jersey:"21"},
  // New York Knicks
  {id:1628973,firstName:"Jalen",lastName:"Brunson",tricode:"NYK",teamName:"New York Knicks",position:"G",jersey:"11"},
  ...
  {id:1629631,firstName:"Josh",lastName:"Hart",tricode:"NYK",teamName:"New York Knicks",position:"G-F",jersey:"3"},
  {id:1630530,firstName:"Deuce",lastName:"McBride",tricode:"NYK",teamName:"New York Knicks",position:"G",jersey:"11"},
  {id:1629611,firstName:"Mitchell",lastName:"Robinson",tricode:"NYK",teamName:"New York Knicks",position:"C",jersey:"23"},
  // Oklahoma City Thunder
  {id:1628983,firstName:"Shai",lastName:"Gilgeous-Alexander",tricode:"OKC",teamName:"Oklahoma City Thunder",position:"G",jersey:"2"},
  {id:1631096,firstName:"Chet",lastName:"Holmgren",tricode:"OKC",teamName:"Oklahoma City Thunder",position:"C",jersey:"7"},
  {id:1631114,firstName:"Jalen",lastName:"Williams",tricode:"OKC",teamName:"Oklahoma City Thunder",position:"G-F",jersey:"8"},
  ...
  {id:1630178,firstName:"Aaron",lastName:"Wiggins",tricode:"OKC",teamName:"Oklahoma City Thunder",position:"G-F",jersey:"21"},
  {id:1629611,firstName:"Alex",lastName:"Caruso",tricode:"OKC",teamName:"Oklahoma City Thunder",position:"G",jersey:"8"},
  {id:1641733,firstName:"Nikola",lastName:"Topic",tricode:"OKC",teamName:"Oklahoma City Thunder",position:"G",jersey:"4"},
  {id:1641738,firstName:"Ajay",lastName:"Mitchell",tricode:"OKC",teamName:"Oklahoma City Thunder",position:"G",jersey:"12"},
  // Orlando Magic
  {id:1631094,firstName:"Paolo",lastName:"Banchero",tricode:"ORL",teamName:"Orlando Magic",position:"F",jersey:"5"},
  ...
  {id:1630591,firstName:"Jalen",lastName:"Suggs",tricode:"ORL",teamName:"Orlando Magic",position:"G",jersey:"4"},
  {id:203482,firstName:"Markelle",lastName:"Fultz",tricode:"ORL",teamName:"Orlando Magic",position:"G",jersey:"20"},
  {id:1629628,firstName:"Cole",lastName:"Anthony",tricode:"ORL",teamName:"Orlando Magic",position:"G",jersey:"50"},
  {id:1630181,firstName:"Moritz",lastName:"Wagner",tricode:"ORL",teamName:"Orlando Magic",position:"C",jersey:"21"},
  {id:1641730,firstName:"Anthony",lastName:"Black",tricode:"ORL",teamName:"Orlando Magic",position:"G",jersey:"0"},
  // Philadelphia 76ers
  ...
  {id:1629057,firstName:"Kelly",lastName:"Oubre Jr.",tricode:"PHI",teamName:"Philadelphia 76ers",position:"F",jersey:"12"},
  {id:1630174,firstName:"Caleb",lastName:"Martin",tricode:"PHI",teamName:"Philadelphia 76ers",position:"F",jersey:"16"},
  {id:1641735,firstName:"Guerschon",lastName:"Yabusele",tricode:"PHI",teamName:"Philadelphia 76ers",position:"F",jersey:"28"},
  // Phoenix Suns
  ...
  {id:1629638,firstName:"Ryan",lastName:"Dunn",tricode:"PHX",teamName:"Phoenix Suns",position:"G-F",jersey:"0"},
  {id:1629771,firstName:"Tyus",lastName:"Jones",tricode:"PHX",teamName:"Phoenix Suns",position:"G",jersey:"21"},
  // Portland Trail Blazers
  {id:1630703,firstName:"Scoot",lastName:"Henderson",tricode:"POR",teamName:"Portland Trail Blazers",position:"G",jersey:"00"},
  ...
  {id:1641726,firstName:"Donovan",lastName:"Clingan",tricode:"POR",teamName:"Portland Trail Blazers",position:"C",jersey:"23"},
  {id:1641734,firstName:"Toumani",lastName:"Camara",tricode:"POR",teamName:"Portland Trail Blazers",position:"F",jersey:"33"},
  // Sacramento Kings
  ...
  {id:1629744,firstName:"Colby",lastName:"Jones",tricode:"SAC",teamName:"Sacramento Kings",position:"G-F",jersey:"20"},
  // San Antonio Spurs
  ...
  {id:1630174,firstName:"Malaki",lastName:"Branham",tricode:"SAS",teamName:"San Antonio Spurs",position:"G",jersey:"12"},
  {id:1641731,firstName:"Zach",lastName:"Collins",tricode:"SAS",teamName:"San Antonio Spurs",position:"C",jersey:"23"},
  // Toronto Raptors
  {id:1630567,firstName:"Scottie",lastName:"Barnes",tricode:"TOR",teamName:"Toronto Raptors",position:"F",jersey:"4"},
  {id:1629628,firstName:"RJ",lastName:"Barrett",tricode:"TOR",teamName:"Toronto Raptors",position:"G-F",jersey:"9"},
  {id:1629611,firstName:"Immanuel",lastName:"Quickley",tricode:"TOR",teamName:"Toronto Raptors",position:"G",jersey:"5"},
  {id:204001,firstName:"Jakob",lastName:"Poeltl",tricode:"TOR",teamName:"Toronto Raptors",position:"C",jersey:"25"},
  {id:1641727,firstName:"Gradey",lastName:"Dick",tricode:"TOR",teamName:"Toronto Raptors",position:"G",jersey:"1"},
  {id:1641732,firstName:"Jonathan",lastName:"Mogbo",tricode:"TOR",teamName:"Toronto Raptors",position:"F",jersey:"8"},
  // Utah Jazz
  ...
  {id:1631117,firstName:"Walker",lastName:"Kessler",tricode:"UTA",teamName:"Utah Jazz",position:"C",jersey:"24"},
  ...
  {id:1641739,firstName:"Isaiah",lastName:"Collier",tricode:"UTA",teamName:"Utah Jazz",position:"G",jersey:"0"},
  {id:1641737,firstName:"Kyle",lastName:"Filipowski",tricode:"UTA",teamName:"Utah Jazz",position:"F",jersey:"22"},
  {id:1641740,firstName:"Cody",lastName:"Williams",tricode:"UTA",teamName:"Utah Jazz",position:"F",jersey:"13"},
  // Washington Wizards
...
app.get('/api/health', (req, res) => {
  res.json({ ok: true, cacheSize: cache.size, uptime: Math.round(process.uptime()), playerCount: NBA_PLAYERS.length });
});
...
app.get('/api/scoreboard', async (req, res) => {
  ...
  try {
    ...
    const games = data.scoreboard.games.map(g => ({
      gameId: g.gameId, status: g.gameStatus, statusText: g.gameStatusText,
      period: g.period, clock: g.gameClock,
      home: { teamId: g.homeTeam.teamId, tricode: g.homeTeam.teamTricode, score: g.homeTeam.score },
      away: { teamId: g.awayTeam.teamId, tricode: g.awayTeam.teamTricode, score: g.awayTeam.score },
    }));
  ...
  try {
    ...
    for (const g of sb.games) {
      ...
      return res.json({
        ...
        player: { id: player.personId, name: player.name, firstName: player.firstName, lastName: player.familyName, jersey: player.jerseyNum, position: player.position },
        stats: {
          points: s.points ?? 0, rebounds: s.reboundsTotal ?? 0, assists: s.assists ?? 0,
          steals: s.steals ?? 0, blocks: s.blocks ?? 0,
          fgMade: s.fieldGoalsMade ?? 0, fgAttempted: s.fieldGoalsAttempted ?? 0,
          fgPct: Math.round((s.fieldGoalsPercentage ?? 0) * 1000) / 10,
          fg3Made: s.threePointersMade ?? 0, fg3Attempted: s.threePointersAttempted ?? 0,
          fg3Pct: Math.round((s.threePointersPercentage ?? 0) * 1000) / 10,
          ftMade: s.freeThrowsMade ?? 0, ftAttempted: s.freeThrowsAttempted ?? 0,
    ...
    return res.json({ found: false, reason: 'No active game today' });
  } catch (e) {
    res.status(502).json({ error: 'Lookup failed', message: e.message });
  }
});

app.listen(PORT, () => console.log(`NBA proxy on :${PORT} — ${NBA_PLAYERS.length} players`));
